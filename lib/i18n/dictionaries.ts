...
const messages = {
  he: {
    ...
    "reports.receiptTitle": "קבלה",
    "reports.receiptSubtitle": "פרטי עסקה",
    "reports.printReceipt": "הדפס קבלה",
    "reports.closeModal": "סגור",
    "reports.debugKeysLabel": "מפתחות JSON (שורה ראשונה):",
    "reports.receiptRawFields": "כל השדות (גולמי)",
  ...
  en: {
    ...
    "reports.receiptTitle": "Receipt",
    "reports.receiptSubtitle": "Transaction details",
    "reports.printReceipt": "Print receipt",
    "reports.closeModal": "Close",
    "reports.debugKeysLabel": "JSON keys (first row):",
    "reports.receiptRawFields": "All fields (raw)",
